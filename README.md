...
~~~sh
# getting the code
git clone git@github.com:nko5/los-sanluisinos.git && cd ./los-sanluisinos/
...
# deploying to Modulus (to http://los-sanluisinos.2015.nodeknockout.com/)
modulus deploy
...
~~~html
<iframe src="http://nodeknockout.com/iframe/los-sanluisinos" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
